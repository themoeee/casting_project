...
DEFAULT_OUTPUT_PATH = PROJECT_ROOT / "data" / "processed" / "long_form" / "cavity_sensors_parts"
DEFAULT_MERGED_OUTPUT_PATH = PROJECT_ROOT / "data" / "processed" / "final_input_data" / "cavity_sensor_data.parquet"
DEFAULT_MANIFEST_PATH = PROJECT_ROOT / "data" / "processed" / "processing_info" / "cavity_sensors_manifest.parquet"
DEFAULT_REMOVED_CYCLES_CSV = PROJECT_ROOT / "data" / "processed" / "processing_info" / "removed_cavity_sensor_cycles.csv"
