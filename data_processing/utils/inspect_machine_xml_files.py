...
try:
    from data_processing.utils.read_xml_file import load_xml_data, summarize_xml_curves
...
DEFAULT_OUTPUT_DIR = DEFAULT_DATA_ROOT / "processed" / "processing_info" / "xml_inspection"
